...
def main(args):
    ...
    # Restricting lap, better left untouched
    lap_limiter = 3
    timestep_limit = 320
    ...
    dir = os.path.join( dir,
        datetime.datetime.now().strftime("torcs-remi-%Y-%m-%d-%H-%M-%S-%f"))
    ...
    # Path to RL Expert data
    args.rl_expert_path = os.path.join( data_dir, "DDPG_20181215Run_ckpt1368_220eps/expert_data.npz")
